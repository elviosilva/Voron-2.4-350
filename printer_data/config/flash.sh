...
octopus_flash(){
	...
	python3 ~/katapult/scripts/flash_can.py -f ~/klipper/octopus_klipper.bin -d /dev/serial/by-id/usb-Klipper_stm32f446xx_200004001250535556323420-if00
}
...
ebb36_flash(){
	...
	python3 ~/katapult/scripts/flash_can.py -f ~/klipper/ebb36_klipper.bin -u 6b76e8780c16
}
